...
class Search_controller extends CI_Controller {
 ...
 function searchcaselog()
 {
  ...
  function searchcaselog_details()
  {
          ...
          $config["base_url"] = base_url()."index.php/search_caselog_controller/searchcaselog_details";
 ...
 if($this->session->userdata('logged_in'))
   {
     ...
     $data['id'] = $session_data['id'];
     $this->load->view('header', $data);
     $this->load->view('search/search_casenumber_view');
   }
   else
   {
     redirect('login', 'refresh');
...
function searched_casenumbered()
{
  ...
  if ($datas['case_number'] == true)
  {
   ...
   $datas['case_number'] = $this->user->case_number_checking($case_number);
   $this->load->view('header',$data);
   $this->load->view('search/searched_casenumbered_view',$datas);
  }
  else
  {
   redirect('login', 'refresh');
