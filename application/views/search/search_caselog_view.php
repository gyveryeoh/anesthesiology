...
<form method="get" autocomplete="off" action="<?php echo base_url(); ?>index.php/search_controller/searchcaselog">
 <table width="90%" cellpadding="1" cellspacing="0">
          ...
          <tr>
                    <td class="border-less question" align="right" width="20%" colspan=2>CASE NUMBER</td>
                     <td class="border-less answer" colspan="9">
                        <input type="text" name="case_number" size="30">
                    </td>
          </tr>
          <tr>
		...
		?>
          ...
          ?>
          <tr class="answer"><td><a href="<?php echo base_url(); ?>index.php/caselog_controller/index/<?php echo $row->p_id; ?>/<?php echo $row->patient_form_id; ?>?&user_id=<?php echo $this->input->get('user_id'); ?>&status_id=<?php echo $this->input->get('status_id'); ?>&status=<?php echo $row->anesth_status_id; ?>"><?php echo $row->patient_info_case_number; ?></a></td>
         <?php
