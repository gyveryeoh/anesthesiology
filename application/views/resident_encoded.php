<table width="90%" cellpadding="1" cellspacing="0" style="border-top: hidden;font-size: 13px;">
          <tr>
                    <td class="border-less header" align="center" colspan="7">ENCODED SUMMARY</td>
          </tr>
          <tr>
                    <?php foreach($resident_information as $data): ?>
                    <td class="border-less question" width=15%>RESIDENT NAME</td><td class="border-less answer" colspan=7><?php echo $data->lastname; ?>, <?php echo $data->firstname; ?> <?php echo $data->middle_initials; ?>.</b></td>
                    <?php endforeach; ?>
          </tr>
          <?php
          $x=0;
          ...
          ?>
          <tr class="answer">
                    <td align="left" class="border-less" style="font-weight:bold;font-size: 15px;" colspan=7>
                    <?php echo '<a href="'.base_url().'index.php/home/resident_encoded?resident_id='.$this->input->get('resident_id').'&status=0">ALL : '.$count_all.'</a> |
                    <a href="'.base_url().'index.php/home/resident_encoded?resident_id='.$this->input->get('resident_id').'&status='.$list_id[6].'">OPEN : '.$count_open.'</a> |
          ...
          <tr>
                    <td colspan="7" align="center"><?php if($this->session->flashdata("success") !== FALSE){ echo $this->session->flashdata("success"); }?></td>
          </tr>
          ...
          <th class="question border-less"><b>DATE OF OPERATION</b></th>
          ...
          <tr class="answer" align=center>
            ...
            <td align="center"><?php echo $patients_infos->operation_date; ?></td>
