     ...
     echo "<tr><td></td>";
          ...
          <tr>
                    ...
                    <td class="border-less" colspan="2">
                        <input type="radio" name="crystalloids" value="YES" class="required" <?php if($data->crystalloids=="YES"){ echo "checked";}?>> Yes
		  ...
		  <tr>
                    ...
                    <td class="border-less" colspan="2">
                        <input type="radio" name="colloids" value="YES" class="required" id="colloids_used_show" <?php if($data->colloids == "YES"){ echo "checked";}?>> Yes
          ...
          <tr id="other_colloids_used" style="display:none;">
            ...
            <td class="border-less"><input type="text" size="20" name="other_colloids_used" class="colloids_used_valid" value="<?php echo $data->colloids_used?>"></td>
          </tr>
          <tr>
          <td class="border-less" width="25%"><b>Blood Products Used :</b></td>
                    <td class="border-less" colspan="2">
					<input type="radio" name="blood_products_used" value="YES" class="required" <?php if($data->blood_products_used=="YES"){ echo "checked";}?>> Yes 
					<input type="radio" name="blood_products_used" value="NO" class="required" <?php if($data->blood_products_used=="NO"){ echo "checked";}?>> No 
					<input type="radio" name="blood_products_used" value="N/A" class="required" <?php if($data->blood_products_used=="N/A"){ echo "checked";}?>> N/A
					</td>
          </tr>
          <tr>
                    <td class="border-less"></td><td class="border-less" width="25%"><b>Fresh Whole Blood :</b> </td>
					<td class="border-less">
					<input type="radio" name="fresh_whole_blood" value="YES" class="required" <?php if($data->fresh_whole_blood=="YES"){ echo "checked";}?>> Yes 
					<input type="radio" name="fresh_whole_blood" value="NO" <?php if($data->fresh_whole_blood=="NO"){ echo "checked";}?>> No
					</td>
          </tr>
		  <tr>
                    <td class="border-less"></td><td class="border-less" width="25%"><b>Cyroprecipitate :</b> </td>
					<td class="border-less">
						<input type="radio" name="cyroprecipitate" value="YES" class="required" <?php if($data->cyroprecipitate=="YES"){ echo "checked";}?>> Yes 
						<input type="radio" name="cyroprecipitate" value="NO"  <?php if($data->cyroprecipitate=="NO"){ echo "checked";}?>> No
					</td>
          </tr>
		  <tr>
                    <td class="border-less"></td><td class="border-less" width="25%"><b>Platelets :</b> </td>
					<td class="border-less">
					<input type="radio" name="platelets" value="YES" class="required" <?php if($data->platelets=="YES"){ echo "checked";}?>> Yes 
					<input type="radio" name="platelets" value="NO" <?php if($data->platelets=="NO"){ echo "checked";}?>> No
					</td>
          </tr>
          <tr>
                    <td class="border-less"></td><td class="border-less" width="25%"><b>Fresh Frozen Plasma :</b> </td>
					<td class="border-less">
					<input type="radio" name="fresh_frozen_plasma" value="YES" class="required" <?php if($data->fresh_frozen_plasma=="YES"){ echo "checked";}?>> Yes 
					<input type="radio" name="fresh_frozen_plasma" value="NO" <?php if($data->fresh_frozen_plasma=="NO"){ echo "checked";}?>> No
					</td>
          </tr>
          <tr>
                    <td class="border-less"></td><td class="border-less" width="25%"><b>Packed RBC :</b> </td>
					<td class="border-less">
					<input type="radio" name="packed_rbc" value="YES" class="required" <?php if($data->packed_rbc=="YES"){ echo "checked";}?>> Yes 
					<input type="radio" name="packed_rbc" value="NO" <?php if($data->packed_rbc=="NO"){ echo "checked";}?>> No
					</td>
          </tr>
          <tr>
                    <td class="border-less"></td><td class="border-less"><b>Others :</b> </td>
					<td class="border-less" colspan="2">
					<textarea name="others" cols="35" class="required"><?php echo $data->others;?></textarea>
					</td>
          </tr>
           <tr>
