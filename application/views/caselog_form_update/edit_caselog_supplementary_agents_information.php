...
<div align="center">		   
<form method="post" id="anesth_form"  action="<?php echo base_url(); ?>index.php/edit_caselog_controller/edit_supplementary_agents_information">
...
<table border="0" cellpadding="0" width="80%" cellspacing="2" style="font-family: sans-serif; border: solid 1px; font-size: 14px;">
 <tr>
		  ...
		  echo "<td bgcolor='FAFAD2'><input type='checkbox' value='".$aad->id."' id='".$x."' name='main_agent[]'";
