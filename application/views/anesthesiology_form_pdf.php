...
?>
<div align="center">
<table border="0" cellpadding="0" width="100%" cellspacing="5" style="font-family: sans-serif; border: solid 1px; font-size: 10px;">
    <tr>
...
<div align="center">
<table border="0" cellpadding="0" width="100%" cellspacing="5" style="font-family: sans-serif; border: solid 1px; font-size: 12px; border-top: hidden;">
    <tr>
    ...
    <tr>
        <td class="border-less header" align="left" colspan="4"><b>Main Agents :</b></td>
    </tr>
    <?php
          $num_cols = 5;
          $current_col = 0;
    ...
    ?>
    <tr>
        <td class="border-less header" align="left" colspan="4"><b>Supplementary Agents :</b></td>
    </tr>
    <?php
          $num_col = 5;
          $current_co = 0;
    ...
    ?>
    <tr>
        <td class="border-less header" align="left" colspan="4"><b>Post-Op Pain Agents :</b></td>
    </tr>
    <?php
          $num_col = 5;
          $current_co = 0;
    ...
    <tr>
          ...
          for ($t=0;$t<count($apopmd_id+$apopmd_name1);$t++)
          {
           ...
           ?>
    <tr>
        <td class="border-less header" align="left" colspan="4"><b>Monitors Used :</b></td>
    </tr>
    <?php
          $num_col = 4;
          $current_co = 0;
    ...
    <div align="center">
<table border="0" cellpadding="0" width="100%" cellspacing="3" style="font-family: sans-serif; border: solid 1px; font-size: 12px;border-top: hidden;">
    <tr>
